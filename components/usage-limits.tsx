...
export default function UsageLimits({ userId, subscriptionTier = 'free' }: UsageLimitsProps) {
  ...
  const limits = (() => {
    switch (subscriptionTier) {
      ...
      default:
        return {
          searches: FREE_TIER.searchesPerDay,
          guidanceRequests: 3
        };
    }
  })();
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm font-medium">{formatUsage(usage.guidanceRequests, limits.guidanceRequests)}</span>
            </div>
            <div className="h-2 bg-muted rounded-full overflow-hidden">
              <div 
                className="h-full bg-primary" 
