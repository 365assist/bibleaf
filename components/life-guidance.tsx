...
import { Loader2, BookOpen, Lightbulb, Heart, AlertCircle, Info, Crown, Zap } from "lucide-react"
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <Card className="border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-amber-700 dark:text-amber-400">Daily Guidance Limit Reached</CardTitle>
            <CardDescription className="text-amber-600 dark:text-amber-500">
              You've used all 5 of your free daily guidance requests
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-6">
            <div className="bg-white dark:bg-gray-800/50 rounded-lg p-6 border border-amber-200 dark:border-amber-700/50">
              ...
              <p className="text-amber-600 dark:text-amber-500 mb-4">
                Upgrade to Premium for unlimited biblical guidance, deeper insights, and personalized spiritual growth
                tools.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  ...
                  <h4 className="font-medium text-amber-700 dark:text-amber-400">Unlimited Guidance</h4>
                  <p className="text-sm text-amber-600/80 dark:text-amber-500/80">Ask as many questions as you need</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
                    <BookOpen className="w-6 h-6 text-amber-600 dark:text-amber-400" />
                  </div>
                  <h4 className="font-medium text-amber-700 dark:text-amber-400">Advanced Features</h4>
                  <p className="text-sm text-amber-600/80 dark:text-amber-500/80">
                    Commentary, cross-references, and more
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
                  ...
                  <h4 className="font-medium text-amber-700 dark:text-amber-400">Personalized Experience</h4>
                  <p className="text-sm text-amber-600/80 dark:text-amber-500/80">Tailored to your spiritual journey</p>
                </div>
              </div>
            ...
            <div className="text-sm text-amber-600/70 dark:text-amber-500/70">
              <p>Your daily guidance limit resets at midnight UTC.</p>
              <p className="mt-1">Continue reading the Bible and exploring verses without limits!</p>
            </div>
          </CardContent>
        </Card>
      </div>
